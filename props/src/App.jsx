...
function App() {
  ...
  function testar(){
    // console.log(produtos);
    let produto = {
      id: Date.now(), modelo: "Produto Secreto", preco: 10
    }
  ...
  function cadastrar(){
    let produto = {
      id: Date.now(), modelo: inputModelo, preco: Number(inputPreco)
    }
    setProdutos([produto, ...produtos])
  }
  ...
  return (
    <div className='container-app'>
      ...
      <div className='cadastro'>
        ...
        <input type="text" id='modelo' placeholder='Modelo do produto'
          value = {inputModelo}
